                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-sm-auto col-4">
                            <form method="POST" enctype="multipart/form-data" id="form_upload_image">
                                <input type="hidden" id="email_" name="email_" value="<?= $userData['usuario'] ?>" readonly>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-12">
                                    ...
                                    <div class="input-group">
                                        <input id="telefono" name="telefono" maxlength="10" pattern="[0-9]" class="form-control" type="tel" placeholder="+40 735 631 620" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $userData['telefono'] ?>">
                                    </div>
                                </div>
