            ...
            <div class="container">
                <div class="row mt-lg-0 mt-8">
                    <div class="col-lg-5 my-auto">
                        <h1 class="display-1 text-bolder text-gradient text-danger fadeIn1 fadeInBottom mt-5">Error 500</h1>
                        <h2 class="fadeIn3 fadeInBottom opacity-8">Algo salió mal</h2>
