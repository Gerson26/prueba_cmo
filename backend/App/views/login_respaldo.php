                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-7">
                                <div class="card-header pb-0 text-start">
                                    <h5 style="color: #293A90;" class="font-weight-bolder text-center">LXVIII Congreso Nacional de Ortopedia 2023 </h5>
                                    <hr>
                                    <h4 style="color: #a19a9a;" class="font-weight-bolder text-center">"Colegio Mexicano de Ortopedia y Traumatología"</h4>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n9">
                                ...
                                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('/assets/img/curved-images/login.jpg')"></div>
                                <!-- <video autoplay muted loop>
                                    <source class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" src="/assets/vid/video_lasr.mp4" type="video/mp4">
                                </video> -->
