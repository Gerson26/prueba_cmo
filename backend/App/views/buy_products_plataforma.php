                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <form class="form_compra" method="POST" action="">
                                                    ...
                                                    <div class="row d-none" id="cont-pay-tarjeta">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                                            <label for="">CVC</label>
                                                            <input pattern="[A-Za-z0-9]{2,3}" type="text" name="codigoseguridad" size="3" maxlength="3" data-conekta="card[cvc]" class="form-control" placeholder="Código de seguridad" required>
                                                            <div class="invalid-feedback">
